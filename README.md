...
- [x] **persona.mdによる個人プロフィール反映** — persona.mdの人物像をシステムプロンプトに反映・自動更新
- [x] **カレンダー表示** — 日記を書いた日を緑色で表示、日付クリックでその日の記録を確認
- [x] **週次振り返り（土曜日に今週のあなたへを表示）** — 今週の日記をもとにAIがコメントを生成
...
### v0.3.0 (2026-04-18)
- カレンダー表示（日記を書いた日が緑色で表示、日付クリックでその日の記録を表示）
- 週次振り返り機能（土曜日に今週の日記をもとにコメントを表示）
- UIをミニマルなデザインに変更
- ラベルを「今日のできごと」「今日のリフレーミング」に変更
